...
## Run result
Single-utterance pipeline: Val 0.3506 F1-m, Test 0.4397 F1-m

Setup: 5 epochs for embedding fine-tuning, 30 epochs for whole architecture fine-tuning, dropout rate 0.3, lr 5e-5, batch size 4, unfreeze after 8
0.3517, 0.4400

Setup: 5 epochs for embedding fine-tuning, 30 epochs for whole architecture fine-tuning, dropout rate 0.3, lr 1e-4, batch size 4, unfreeze after 8
0.3595, 0.4331
## Inference
